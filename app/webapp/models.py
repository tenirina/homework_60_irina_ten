...
class Product(models.Model):
    ...
    photo = models.CharField(verbose_name="Photo", max_length=200, null=False, blank=False)
    category = models.CharField(verbose_name="Title", max_length=100, null=False, blank=False, choices=CHOICES)
    balance = models.IntegerField(verbose_name="Balance", null=False, blank=False)
    price = models.DecimalField(verbose_name="Price", max_digits=10, decimal_places=2, null=False, blank=False)
